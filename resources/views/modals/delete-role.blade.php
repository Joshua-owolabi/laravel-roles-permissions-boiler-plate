<div class="modal fade " id="delete-roles-{{ $role->id }}" tabindex="-1" role="dialog" aria-labelledby="delete-user"
    aria-hidden="true">
        ...
        <div class="modal-content delete-modal">
            <form action="/roles/delete" method="POST">
                ...
                <div class="modal-body delete-modal__body">
                    ...
                    <p>Are you sure you want to delete this Role, decide carefully !!!</p>
                </div>
                <div>
                    <button type="submit" class="btn delete-modal__btn float-left ml-4 mb-3">Delete Role</button>
